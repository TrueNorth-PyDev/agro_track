# Generated by Django 5.2.13 on 2026-07-02 06:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('sender', 'Sender / Receiver'), ('dispatcher', 'Logistics Dispatcher'), ('admin', 'Platform Admin')], default='sender', max_length=20, verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('otp_hash', models.CharField(max_length=64, verbose_name='OTP hash')),
                ('purpose', models.CharField(choices=[('registration', 'Email Verification'), ('password_reset', 'Password Reset')], default='registration', max_length=20, verbose_name='purpose')),
